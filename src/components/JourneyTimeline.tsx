...
const milestones: Milestone[] = [
  {
    ...
    title: { en: 'The Beginning of Consistent Personal Service', ta: 'சிறிய அளவில் தொடங்கிய கருணைச் செயல்கள்' },
    desc: {
      ...
      ta: 'தனிப்பட்ட முனைப்பில், தேவையுள்ளவர்களுக்கு உணவு வழங்கும் தொடக்க முயற்சிகள்.',
    },
  },
  {
    year: '2025',
    ...
    registration: true,
    title: { en: 'Formal Registration and Organized Service', ta: 'அதிகாரப்பூர்வ உருவாக்கம்' },
    desc: {
      ...
      ta: '08.04.2025 அன்று நல்லதே நடக்கும் சமூக சேவை அறக்கட்டளை பதிவு செய்யப்பட்டு, ஒழுங்குபடுத்தப்பட்ட மனிதநேய அமைப்பாக வளர்ச்சி பெற்றது.',
    },
  },
  {
    year: '2025–2026',
    ...
    title: { en: 'Multi-Service Expansion', ta: 'பல துறைகளில் விரிந்த சேவை' },
    desc: {
      ...
      ta: 'அன்னதானம், இறுதி மரியாதை, முதியோர் மீட்பு, கல்வி உதவி, மருத்துவ அவசர நிதி திரட்டல் போன்ற சேவைகள் வலுவடைந்தன.',
    },
  },
  {
    year: '21.03.2026',
    ...
    desc: {
      ...
      ta: 'ஏழை மற்றும் அவசர நோயாளிகளுக்கான முக்கிய உதவி சேவையாக ஆம்புலன்ஸ் அறிமுகப்படுத்தப்பட்டது.',
    },
  },
  {
    year: 'July 2026',
    ...
    title: { en: '500+ Days & Growing', ta: 'ஒரு நம்பகமான சமூக சேவை இயக்கமாக வளர்ச்சி' },
    desc: {
      ...
      ta: 'நேரடி திடல் பணிகள், வெளிப்படைத் தன்மை, சமூக நம்பிக்கை, மற்றும் பலரின் பங்களிப்புடன் வளர்ந்த மனிதநேய முயற்சி.',
    },
  },
];
